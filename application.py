...
app.config['UPLOAD_PATH'] = "D:\\Cyber Security\\PGDCD\\projects\\Image forensics\\uploads"
...
def upload_file():
    if request.method == "POST":
        ...
        extract_the_data("D:\\Cyber Security\\PGDCD\\projects\\Image forensics\\uploads")
        data = pd.read_csv("D:\\Cyber Security\\PGDCD\\projects\\Image forensics\\image_metadata.csv")
        # print(type(df))
